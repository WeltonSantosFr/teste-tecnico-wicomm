    ...
    <main className="flex flex-col gap-5">
      <div className="bg-[url('/src/assets/unsplash_FP7cfYPPUKM.png')] bg-no-repeat bg-center bg-cover w-full h-[550px] flex flex-col justify-center items-center">
        <div className="flex flex-col justify-evenly w-[80%] h-[70%]">
          ...
          <button className="font-barlow font-bold text-base leading-5 text-center text-black1 bg-orange1 h-[50px] w-[120px] rounded-[4px]">
            CONFIRA
          </button>
        </div>
          ...
          >
            <div className="w-full relative flex items-center justify-center">
              <ButtonBack
                ...
                id="prev"
              >
                <BsArrowLeftShort className="bg-grey2 w-[32px] h-[32px] rounded-[4px] hover:bg-orange1">
                  <path
                    d="M7 1L1 7L7 13"
                    stroke="white"
                    strokeWidth={2}
                  ...
                  >
                    <Slide index={0}>
                      <div className="flex flex-col items-center">
                        <div className="bg-background rounded-full w-[180px] h-[180px] flex items-center justify-center">
                          <img
                            src="src\assets\image 2.png"
                            alt="protein bag"
                            className="object-center w-[110px]"
                          />
                        </div>
              ...
              <ButtonNext
                ...
                id="next"
              >
                <BsArrowRightShort className="bg-grey2 w-[32px] h-[32px] rounded-[4px] hover:bg-orange1">
                  <path
                    d="M1 1L7 7L1 13"
                    stroke="white"
                    strokeWidth={2}
              ...
              <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                ...
                <Slider>
                  <div
                    ...
                    className="h-full flex lg:gap-[20px] md:gap-6 gap-14 items-center justify-center transition ease-out duration-700"
                  >
                    <Slide index={0} className="w-[280px] h-[350px]">
                    ...
                    <Slide index={1} className="w-[280px] h-[350px]">
                      <div className="border-[1px] border-background rounded-[4px] w-[280px] h-[350px] flex flex-col justify-evenly items-center">
                        <div className="flex flex-row w-full justify-center">
                          <img
                            src="src\assets\image 1.png"
                    ...
                    <Slide index={2} className="w-[280px] h-[350px]">
                      <div className="border-[1px] border-background rounded-[4px] w-[280px] h-[350px] flex flex-col justify-evenly items-center">
                        <div className="flex flex-row w-full justify-center">
                          <img
                            src="src\assets\image 1.png"
                    ...
                    <Slide index={3} className="w-[280px] h-[350px]">
                      <div className="border-[1px] border-background rounded-[4px] w-[280px] h-[350px] flex flex-col justify-evenly items-center">
                        <div className="flex flex-row w-full justify-center">
                          <img
                            src="src\assets\image 1.png"
      ...
      <div className="bg-[url('/src/assets/background.png')] bg-no-repeat bg-center bg-cover w-full h-[460px] flex flex-col justify-center items-center bg-black1 relative">
                ...
                <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                  <Slider>
                    <div
                      ...
                      className="h-full flex lg:gap-[20px] md:gap-6 gap-14 items-center justify-center transition ease-out duration-700"
                    >
                      <Slide index={0} className="w-[280px] h-[300px]">
                        <img src="src\assets\Rectangle 38.png" alt="member1" />
                      </Slide>
                      <Slide index={1} className="w-[280px] h-[300px]">
                        <img src="src\assets\Rectangle 39.png" alt="member2" />
                      </Slide>
                      <Slide index={2} className="w-[280px] h-[300px]">
        ...
        <button className="font-barlow font-bold text-[16px] leading-[20px] text-center bg-orange1 w-[140px] h-[50px] absolute -bottom-[20px] rounded-[4px]">
          VER TODOS
        </button>
      </div>
      <div className="container mx-auto w-full z-10">
      ...
      <div className="w-full h-[540px] bg-gradient-to-b from-dark3 to-black1 flex flex-col justify-center items-center">
        <div className="flex justify-between w-[85%] mt-[50px] -mb-[50px]">
          ...
          <button className="font-barlow font-bold text-[14px] leading-[20px] text-center text-black1 w-[130px] h-[40px] bg-orange1 rounded-[4px]">
            LER TODOS
          </button>
        </div>
        <div className="container mx-auto min-w-full min-h-full z-20">
                  ...
                  <Slider>
                    ...
                    >
                      <Slide index={0} className="min-w-[380px] min-h-[380px]">
                        <div className=" w-[380px] h-[380px] flex flex-col justify-between border-[1px] border-dark3">
                          <img
      ...
      <div className="flex justify-center gap-[20px] mt-[60px]">
        <div className="w-[475px] h-[280px] bg-gradient-to-bl from-grey1 via-dark2 to-black1 flex">
          <div className="flex flex-col justify-center gap-[25px] ml-[40px]">
            ...
            <button className="font-barlow font-bold text-[14px] leading-[20px] text-center text-black1 w-[120px] h-[40px] bg-orange1 rounded-[4px]">
              CONSULTE
            </button>
          </div>
